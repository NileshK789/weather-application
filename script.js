...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(img/beautiful-sea-ocean-with-cloud-blue-sky.jpeg)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(img/buildings-5528981.jpeg)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(img/waters-3102729.jpeg)';
    }
    else if (status === 'Snow') {
        document.body.style.backgroundImage = 'url(img/road-mountain-ski-resort-surrounded-by-fir-trees.jpeg)';
    }
    else if (status === 'Sunny') {
        document.body.style.backgroundImage = 'url(img/park-sunset.jpeg)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(img/thunder-1368797.jpeg)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(img/plant-4520102_1920.jpeg)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(img/clouds-2517653.jpeg)';
    }
